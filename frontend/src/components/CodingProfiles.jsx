...
const profiles = [
  {
    platform: 'Codolio',
    username: 'saharhx',
    url: 'https://codolio.com/profile/saharhx',
    color: '#2D6A4F',
    percentile: 80,
    stats: {
      rating: '1671',
      problems: '1563',
      badge: '431 Active Days',
      contests: '64',
    },
    icon: (
...
const achievements = [
  ...
  { text: 'Lead at WCE MLSC — Microsoft Learn Student Chapter, Walchand College of Engineering', icon: '�' },
];
...
const CodingProfiles = () => {
  ...
  return (
    <section className="py-20 px-4 md:px-10 relative overflow-hidden theme-transition" style={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      {/* Profile Cards Grid */}
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-16 relative z-10">
